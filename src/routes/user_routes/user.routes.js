...
const { addFollowUsers , check_is_following} = require("../../controller/user_controller/add_follow_user.controller");
...
router.post('/check_follow_user',uploads.none(), check_is_following);
