...
const { getChatList_by_user_id,getUserList_by_user_id } = require("../../controller/chat_controller/chat_list.controller");
...
router.get('/get_user_list_by_user_id',getUserList_by_user_id)
