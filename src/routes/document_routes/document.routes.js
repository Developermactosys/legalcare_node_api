...
const { uploadDocument, getAllDocument ,get_document_by_user_id,updateStatusForDoc,uploadMultipleDoc} = require('../../controller/document_controller/document.controller')
